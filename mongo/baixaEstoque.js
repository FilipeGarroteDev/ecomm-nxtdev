...
function comprarProduto(nome, quantidade, comprador) {
  ...
  if (!product) { return console.log('Não existe o produto informado. Refaça a operação.'); }

  if (product.quantidadeEmEstoque < quantidade) { return console.log(`Não há unidades do ${nome} disponíveis em estoque.`); }
  ...
  return console.log('Produto comprado com sucesso!');
}
