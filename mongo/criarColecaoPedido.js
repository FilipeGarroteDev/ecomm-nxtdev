          ...
          items: {
            ...
            properties: {
              ...
              quantidade: {
                bsonType: 'int',
                minimum: 1,
                description: "O campo 'quantidade' deve ser um número inteiro cujo valor é, no mínimo, 1.",
              },
              desconto: {
                bsonType: 'decimal',
                minimum: 0,
                exclusiveMinimum: true,
                description: "O campo 'desconto' deve ser um valor decimal e, obrigatoriamente, maior que 0. Preenchimento opcional.",
              },
              precoUnitario: {
                bsonType: 'decimal',
                minimum: 0,
                exclusiveMinimum: true,
                description: "O campo 'precoDecimal' deve ser um número decimal e, obrigatoriamente, maior que 0.",
              },
            },
          },
        },
